	...
	?>
		...
		<table border="0" cellspacing="0" cellpadding="0" class="Tabla2">
			...
			<tr class="Tabla26">
				...
				<td colspan="4" style="text-align:left;width:0.679cm; " class="Tabla2_A8_BT">
					<p class="P50">
						No. Interior
					</p>
				</td>
				<td colspan="7" style="text-align:left;width:0.679cm; " class="Tabla2_A8_BRT">
					<p class="P50">
						Colonia
					</p>
				</td>
			...
			<tr class="Tabla29">
				...
				<td colspan="4" style="text-align:left;width:0.55cm; " class="Tabla2_V9">
					<p class="P26">
			...
			<tr class="Tabla29">
				<td colspan="2" style="text-align:center; vertical-align: middle; width:0.679cm; height:25px " class="Tabla2_A11">
					<p class="P7">
					<span class="T28">
					<?php 	$a_cp = str_split(strtoupper(substr("00000".$company->CODIGO_POSTAL,-5))); ?>
			...
			<tr class="Tabla34">
				...
				<td style="text-align:left;width:0.6cm; " class="Tabla3_F4">
					...
					<span class="T28">
						...
						<?php $str_est = str_split(substr("00000".$establecimientos,-5)); ?>
						<?= isset($str_est[0])?$str_est[0]:'0';?>
					</span>
					</p>
				</td>
				<td style="text-align:left;width:0.6cm; " class="Tabla3_F4">
					<p class="P7"><span class="T28">
						<?= isset($str_est[1])?$str_est[1]:'0';?>
					</span>
					</p>
				</td>
				...
				<td style="text-align:left;width:0.6cm; " class="Tabla3_K4">
					<p class="P7">
					<span class="T28">
					<?php $sNintegrantes = str_split(substr("000".$model->NUMERO_INTEGRANTES,-3)); ?>
					<?= $sNintegrantes[0]?:'0'; ?>
					</span>
					</p>
				</td>
