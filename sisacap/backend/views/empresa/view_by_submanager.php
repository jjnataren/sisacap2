			...
			<div class="panel-heading">
				<h3>
					<i class="fa fa-eye"></i>
						...
						<?= Yii::t('backend', 'Detalles') ?> <small>de este establecimiento</small>
				</h3>
				...
				<div class="col-md-6 col-xs-12">
					<div class="panel">
						<div class="panel-heading text-primary">
							...
							<h3 class="panel-title"><i class="fa fa-list"></i> <?= Yii::t('backend', ' Datos del establecimiento') ?></h3>
						</div>
						<div class="panel-body">
				...
				<div class="col-md-6 col-xs-12">
					<div class="panel">
						<div class="panel-heading text-primary">
							...
							<h3 class="panel-title">	<i class="fa fa-envelope"></i><?= Yii::t('backend', ' Contacto del establecimiento') ?></h3>
						</div>
						<div class="panel-body">
				...
				<div class="col-md-6 col-xs-12">
					<div class="panel">
						<div class="panel-heading text-primary">
							...
							<h3 class="panel-title"><i class="fa fa-archive"></i><?= Yii::t('backend', ' Centro de trabajo') ?></h3>
						</div>
						<div class="panel-body">
				...
				<div class="col-md-6 col-xs-12">
					<div class="panel">
						<div class="panel-heading text-primary">
							...
							<h3 class="panel-title"><i class="fa fa-map-marker"></i><?= Yii::t('backend', ' Domicilio') ?></h3>
						</div>
						<div class="panel-body">

<?=DetailView::widget ( [ 'model' => $model,'attributes' => [ 'CALLE','NUMERO_EXTERIOR',
																'NUMERO_INTERIOR',
                                                                'LOCALIDAD',
			...
			<div class="panel-footer">
			   <?= Html::a('<i class="fa fa-pencil"></i> Actualizar', ['update-by-sub'], ['class' => 'btn btn-warning'])?>
