	...
	<div class=" col-xs-12 col-sm-12 col-md-12">
		...
		<div class="panel-body">
           ...
           <div class="box box-default">
				                ...
				                <?php $correo = isset($model->iDUSUARIO) ? $model->iDUSUARIO->email : null;?>

					<?=DetailView::widget ( [ 'model' => $model,'attributes' => [ 'DOMICILIO','TELEFONO',

					    ['attribute'=>'CORREO_ELECTRONICO','value'=>$correo ] ] ] )?>
				</div>
				</div>
				</div>
