...
<div class="panel-body">
    ...
    <div class="panel-footer">
								<button id="helppop1" tabindex="0" type="button" class="btn" data-toggle="popover" title="Ayuda" data-content="<?=Yii::t('backend', 'Recuerde que al encriptar la firma, no se podrá usar para otros fines por razones  de seguridad. ') ?>"><i class="fa fa-question-circle"></i>
						</button>
						&nbsp;
