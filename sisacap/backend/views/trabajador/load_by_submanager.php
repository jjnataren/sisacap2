...
<div class="trabajador-form">
	 ...
	 <?php $form = ActiveForm::begin([ 'options'=>['layout' => 'horizontal', 'enctype'=>'multipart/form-data', 'id'=>'form1', 'action' => ['trabajador/load-by-sub']]]); ?>
		...
		<?php if (isset($workers)){ ?>
		 ...
		 <?php $form = ActiveForm::begin([ 'options'=>['layout' => 'horizontal',  'id'=>'form2'],
											'action' => ['trabajador/save-all-by-sub'],	]); ?>
