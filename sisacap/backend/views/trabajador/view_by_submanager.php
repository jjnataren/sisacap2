...
<div class="trabajador-view">
	...
	<div class="panel-footer">
        ...
        <?= Html::a('<i class="fa fa-pencil"></i> Actualizar', ['update-by-sub', 'id' => $model->ID_TRABAJADOR], ['class' => 'btn btn-warning']) ?>
        <?= Html::a('<i class="fa fa-trash-o"></i> Eliminar', ['delete-by-sub', 'id' => $model->ID_TRABAJADOR], [
            'class' => 'btn btn-danger',
            'data' => [
                'confirm' => '¿Seguro que quieres borrar este trabajador?',
                'method' => 'post',
            ],
        ]) ?>
