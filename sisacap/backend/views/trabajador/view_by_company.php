     ...
     <div class=" col-xs-12 col-sm-12 col-md-9">
				<div class="panel panel-info">
					<div class="panel-heading">
						...
						<?= Yii::t('backend', 'Detalles') ?> <small>del trabajador de la empresa matriz</small> </h3>
...
<p>
        <?= Html::a('<i class="fa fa-pencil"></i> Editar', ['updatebyuser', 'id' => $model->ID_TRABAJADOR], ['class' => 'btn btn-warning']) ?>
        <?= Html::a('<i class="fa fa-trash-o"> </i> Eliminar ', ['deletebyuser', 'id' => $model->ID_TRABAJADOR], [
            'class' => 'btn btn-danger',
            'data' => [
                'confirm' => '¿Seguro que quieres borrar a este trabajador? 
