      ...
      <div class=" col-xs-12 col-sm-12 col-md-12">
				<div class="panel <?=($model->isNewRecord)? 'panel-primary' : 'panel-warning' ?>">
					<div class="panel-heading">
						...
						<?= Yii::t('backend', 'Nuevo trabajador perteneciente a la empresa') ?> <small></small> </h3>
					</div>
...
<div class="panel-footer">
								<button id="helppop1" tabindex="0" type="button" class="btn" data-toggle="popover" title="Ayuda" data-content="<?=Yii::t('backend', 'Aquí podrás crear nuevos trabajadores para la empresa, Es importante llenar todos los campos correctamente. Presiona el botón [Guardar] para salvar sus datos') ?>"><i class="fa fa-question-circle"></i>
						</button>
