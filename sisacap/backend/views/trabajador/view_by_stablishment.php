     ...
     <div class=" col-xs-12 col-sm-12 col-md-9">
				<div class="panel panel-info">
					<div class="panel-heading">
						...
						<?= Yii::t('backend', 'Detalles') ?> <small>del rabajador del establecimiento</small> </h3>
    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
           ...
           // 'ROL',
    		...
    		'attribute'=>'PUESTO',
    		'type'=>'raw',
    		'value'=> isset($model->pUESTO) ? $model->pUESTO->NOMBRE_PUESTO : 'no establecido ',
    		],
    		[
...
<p>
        <?= Html::a('<i class="fa fa-pencil "></i> Editar', ['updatebystablish', 'id' => $model->ID_TRABAJADOR], ['class' => 'btn btn-warning']) ?>
