...
$datalistPuesto = ArrayHelper::map(PuestoEmpresa::findAll(['ID_EMPRESA'=>$model->ID_EMPRESA_PADRE]), 'ID_PUESTO', 'NOMBRE_PUESTO');
...
<div class="trabajador-form">
	 ...
	 <?php $form = ActiveForm::begin([ 'options'=>['layout' => 'horizontal', 'enctype'=>'multipart/form-data', 'id'=>'form1', 'action' => ['trabajador/loadbyestablishment']]]); ?>
