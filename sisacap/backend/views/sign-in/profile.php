...
$this->title = Yii::t('backend', 'Editar perfil')
?>
...
<div class="user-profile-form">
    ...
    <div class="form-group">
        <?= Html::submitButton($model->isNewRecord ? Yii::t('frontend', 'Crear') : Yii::t('frontend', 'Actualizar'), ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
    </div>
