    ...
    /**
     ...
     public function rules()
     {
         return [
             ...
             ['role', 'in', 'range' => [self::ROLE_USER, self::ROLE_MANAGER, self::ROLE_ADMINISTRATOR,  self::ROLE_INSTRUCTOR, self::ROLE_SUBMANAGER]],
         ];
     }
    ...
    public static function getRoles($role = false){
        $roles = [
        	...
        	self::ROLE_INSTRUCTOR=>Yii::t('common', 'Instructor'),
        		self::ROLE_SUBMANAGER=>Yii::t('common', 'Sub manager'),
        ];
